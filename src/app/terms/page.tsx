        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              or &quot;your&quot;) and Synn (&quot;we,&quot; &quot;us,&quot; or
              &quot;our&quot;) governing your access to and use of the Synn Git
              visualization service (the &quot;Service&quot;) available at
              synn.gossorg.in.
            </p>
            <div className="bg-muted/50 border border-border rounded-lg p-4">
              <p className="text-muted-foreground leading-relaxed font-medium">
                <strong>Acceptance Required:</strong> By accessing, browsing, or
                ...
                cease all use of the Service and may not access or use the
                Service.
              </p>
            </div>
            <p className="text-muted-foreground leading-relaxed mt-4">
              ...
              organization to these Terms, and &quot;you&quot; will include both
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>
                <strong>&quot;Service&quot;</strong> means the Synn platform,
                including all features, functionality, and content
              </li>
              <li>
                <strong>&quot;User Content&quot;</strong> means any data,
                information, or content you provide through the Service
              </li>
              <li>
                <strong>&quot;Third-Party Services&quot;</strong> means external
                services we integrate with, including GitHub, Clerk, and Neon DB
              </li>
              <li>
                <strong>&quot;Account&quot;</strong> means your user account
                created through Clerk authentication
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Synn is a software-as-a-service platform that provides Git
              repository visualization tools. The Service allows users to
              visualize GitHub repository data, including commit history,
              branches, and related metadata, through an interactive web
              interface. The Service requires GitHub OAuth authentication and
              does not store repository code locally.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>
                Be at least 16 years of age (or the age of majority in your
                jurisdiction)
              </li>
              <li>Have the legal capacity to enter into binding agreements</li>
              <li>
                Possess a valid GitHub account with appropriate repository
                access
              </li>
              <li>
                Authorize our application to access your GitHub data via OAuth
              </li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>
                Access repositories for which you do not have proper
                authorization
              </li>
              <li>
                Share, transfer, or sell your account credentials to any third
                party
              </li>
              <li>
                Use the Service to compete with us or to build a similar or
                competing service
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              software, code, designs, graphics, text, and other content
              (collectively, &quot;Service Content&quot;), is owned by us or our
              licensors and is protected by copyright, trademark, patent, trade
              secret, and other intellectual property laws. All rights not
              expressly granted are reserved.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-4">
              <strong>User Content:</strong> You retain all ownership rights in
              your User Content, including GitHub repository data. By using the
              Service, you grant us a limited, non-exclusive, royalty-free,
              worldwide license to access, use, process, and display your User
              Content solely for the purpose of providing the Service to you.
              This license terminates when you delete your account or remove the
              User Content.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              <strong>Trademarks:</strong> &quot;Synn&quot; and related marks
              are our trademarks. You may not use our trademarks without our
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              , which describes how we collect, use, disclose, and protect your
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              The Service integrates with and depends on the following
              third-party services:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground mb-4">
              <li>
                <strong>GitHub, Inc.:</strong> OAuth authentication and
                repository access via GitHub API. Your use must comply with{" "}
                <a
              ...
              <li>
                <strong>Clerk, Inc.:</strong> User authentication, session
                management, and account services.
              </li>
              <li>
                <strong>Neon, Inc. (Neon DB):</strong> Database hosting and data
                storage services.
              </li>
            </ul>
            <div className="bg-muted/50 border border-border rounded-lg p-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                DISCLAIM ALL LIABILITY FOR ANY FAILURES, OUTAGES, DATA BREACHES,
                SECURITY INCIDENTS, DATA LOSS, CORRUPTION, OR OTHER LAPSES THAT
                MAY OCCUR WITH THIRD-PARTY SERVICES, INCLUDING BUT NOT LIMITED
                TO CLERK, GITHUB, OR NEON DB. ANY ISSUES, DAMAGES, OR LOSSES
                ARISING FROM THIRD-PARTY SERVICE FAILURES, INCLUDING SERVICE
                OUTAGES, API RATE LIMITING, AUTHENTICATION FAILURES, OR DATA
                BREACHES, ARE SUBJECT TO THE TERMS, POLICIES, AND LIABILITY
                LIMITATIONS OF THOSE RESPECTIVE THIRD-PARTY SERVICES. WE DO NOT
                GUARANTEE THE AVAILABILITY, RELIABILITY, SECURITY, OR
                PERFORMANCE OF ANY THIRD-PARTY SERVICES AND SHALL NOT BE LIABLE
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              FROM VIRUSES OR OTHER HARMFUL COMPONENTS. WE DO NOT WARRANT THE
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              SHALL WE, OUR AFFILIATES, LICENSORS, OR SERVICE PROVIDERS BE
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              USE THE SERVICE, REGARDLESS OF THE THEORY OF LIABILITY (CONTRACT,
              TORT, NEGLIGENCE, STRICT LIABILITY, OR OTHERWISE) AND EVEN IF WE
              HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
            </p>
            <p className="text-muted-foreground leading-relaxed mt-4">
              OUR TOTAL LIABILITY FOR ALL CLAIMS ARISING OUT OF OR RELATING TO
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              (c) your violation of any rights of another party; or (d) your
              User Content. We reserve the right to assume the exclusive defense
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              account and stop using the Service at any time by deleting your
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              changes will be indicated by updating the &quot;Effective
              Date.&quot; Your continued use of the Service after such
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              ...
              thereof, at any time with or without notice. We shall not be
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              brought exclusively in the courts of competent jurisdiction in
              that jurisdiction, and you consent to the personal jurisdiction of
              such courts.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              agree to contact us to attempt to resolve the dispute informally.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              <strong>Binding Arbitration:</strong> If informal resolution
              fails, any dispute arising out of or relating to these Terms or
              the Service shall be resolved through binding arbitration in
              accordance with the rules of a recognized arbitration
              organization, except where prohibited by law. You waive any right
              to a jury trial and to participate in a class action lawsuit or
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              shall remain in full force and effect, and the invalid, illegal,
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              For questions regarding these Terms, contact us through our GitHub
              repository. We will respond to inquiries within a reasonable
              timeframe.
            </p>
          </section>
        </div>
