        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>
                <strong>&quot;Service&quot;</strong> means the Synn Git
                visualization platform accessible at synn.gossorg.in
              </li>
              <li>
              ...
              <li>
                <strong>&quot;You&quot; or &quot;User&quot;</strong> means the
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Synn operates as the Data Controller for Personal Data collected
              through the Service. For inquiries regarding data processing,
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>
                <strong>Consent (Article 6(1)(a)):</strong> You provide explicit
                consent by using the Service and authorizing GitHub OAuth
              </li>
              <li>
              ...
              <li>
                <strong>Legal Obligation (Article 6(1)(c)):</strong> Compliance
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>
                <strong>Activity Logs:</strong> Retained for 90 days from
                creation
              </li>
              <li>
                <strong>API Request Logs:</strong> Retained for 30 days from
                creation
              </li>
              <li>
                <strong>Fingerprint Data:</strong> Retained for 30 days after
                last activity
              </li>
              <li>
                <strong>Authentication Tokens:</strong> Retained until revoked
                or account deletion
              </li>
            </ul>
            <p className="text-muted-foreground leading-relaxed mt-4">
              You may request deletion at any time. We may retain certain data
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-3 text-muted-foreground">
              ...
              <li>
                ...
                your Personal Data in a portable format. Exercise via{" "}
                <code className="bg-muted px-2 py-1 rounded">
                  GET /api/gdpr/export
                </code>
              </li>
              ...
              <li>
                <strong>Right to Lodge a Complaint (Article 77):</strong> File a
                complaint with your supervisory authority
              </li>
            </ul>
            <p className="text-muted-foreground leading-relaxed mt-4">
              To exercise these rights, contact us through our GitHub
              repository. We will respond within 30 days as required by GDPR.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>
                ...
                and specific pieces of Personal Data collected
              </li>
              <li>
                <strong>Right to Delete:</strong> Request deletion of Personal
                Data (subject to exceptions)
              </li>
              <li>
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              We do not sell Personal Data. To exercise CCPA rights, use the
              same GDPR endpoints or contact us directly.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              Third-party services (Clerk, GitHub, Neon DB) may process data in
              various jurisdictions. Their privacy policies govern such
              processing.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              We engage the following Data Processors who process Personal Data
              on our behalf:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>
                <strong>GitHub, Inc.:</strong> OAuth authentication and
                repository access (United States)
              </li>
              <li>
                <strong>Clerk, Inc.:</strong> User authentication and session
                management (United States)
              </li>
              <li>
                <strong>Neon DB (Neon, Inc.):</strong> Database hosting and
                storage (United States/European Union)
              </li>
              <li>
                <strong>Vercel, Inc.:</strong> Hosting and infrastructure
                (United States)
              </li>
            </ul>
            <div className="bg-muted/50 border border-border rounded-lg p-4 mt-4">
              <p className="text-muted-foreground leading-relaxed font-medium">
                <strong>Third-Party Liability Disclaimer:</strong> We are not
                responsible for, and expressly disclaim all liability for, any
                data breaches, security incidents, service outages, or other
                failures occurring with third-party processors. Such incidents
                are subject to the terms, policies, and liability limitations of
                those respective services. We recommend reviewing their privacy
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>
                <strong>Device Fingerprinting:</strong> For security, fraud
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              (or 13 in jurisdictions where applicable). We do not knowingly
              collect Personal Data from children. If you believe we have
              collected data from a child, contact us immediately for deletion.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              practices or legal requirements. Material changes will be notified
              by updating the &quot;Effective Date&quot; and, where required by
              law, by additional notice. Continued use after changes constitutes
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              complaint with your local supervisory authority if you believe our
              processing of your Personal Data violates GDPR. Contact
              information for supervisory authorities can be found at{" "}
              <a
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              Policy or our data practices, contact us through our GitHub
              repository. We will respond within 30 days as required by
              applicable law.
            </p>
          </section>
        </div>
