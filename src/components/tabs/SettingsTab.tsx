  ...
  return (
    <div className="bg-bg-card border border-border-main rounded-xl overflow-hidden shadow-sm">
      <div className="px-4 py-3 border-b border-border-main bg-bg-card/50">
        <h3 className="text-sm font-bold text-text-main tracking-tight uppercase tracking-widest text-[10px]">
          {title}
        </h3>
      </div>
...
export function SettingsTab() {
  ...
  const toggleShowMergeCommits = useAppStore(
    (state) => state.toggleShowMergeCommits,
  );
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        <div className="mb-2">
          ...
          <p className="text-text-sub text-sm">
            Manage your workspace preferences and theme
          </p>
        </div>
              ...
              >
                <div className="flex items-center justify-between w-full">
                  <div className="flex items-center gap-2">
                    <Icon
                      className={`w-4 h-4 ${theme === id ? "text-accent-main" : "text-text-sub group-hover:text-text-main"}`}
                    />
                    <span
                ...
                <span className="text-[10px] text-text-sub font-medium leading-tight">
                  {description}
                </span>
              </button>
            ))}
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative w-11 h-6 rounded-full transition-all duration-300 ${
                  !sidebarCollapsed
                    ? "bg-accent-main shadow-lg shadow-accent-main/20"
                    : "bg-bg-tertiary"
                }`}
              >
                <span
          ...
          <SettingsSection title="Current Repository">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-3 bg-bg-main rounded-xl border border-border-main/50">
                <div className="text-[10px] font-black text-text-sub uppercase mb-1">
                  Name
                </div>
              ...
              <div className="p-3 bg-bg-main rounded-xl border border-border-main/50">
                ...
                <div className="text-sm font-bold text-text-main font-mono truncate">
                  {repoInfo.path}
                </div>
              </div>
              <div className="p-3 bg-bg-main rounded-xl border border-border-main/50">
                ...
                <div className="text-sm font-bold text-accent-main font-mono">
              ...
              <div className="p-3 bg-bg-main rounded-xl border border-border-main/50">
                ...
                <div
                  className={`text-sm font-bold ${repoInfo.isClean ? "text-green-500" : "text-yellow-500"}`}
                >
